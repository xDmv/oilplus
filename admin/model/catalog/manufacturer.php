...
class ModelCatalogManufacturer extends Model {
	public function addManufacturer($data) {
		...
		foreach ($data['manufacturer_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "manufacturer_description SET manufacturer_id = '" . (int)$manufacturer_id . "', language_id = '" . (int)$language_id . "', description = '" . $this->db->escape($value['description']) . "', meta_title = '" . $this->db->escape($value['meta_title']) . "', meta_h1 = '" . $this->db->escape($value['meta_h1']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "', meta_keyword = '" . $this->db->escape($value['meta_keyword']) . "', kodp = '" . $this->db->escape($value['kodp']) . "', procent = '" . $this->db->escape($value['procent']). "', koficient = '" . $this->db->escape($value['koficient']). "'");
		}
	...
	public function editManufacturer($manufacturer_id, $data) {
        ...
        $this->db->query("Update `oc_product`, `oc_manufacturer_description` Set `oc_product`.`price2` = (`oc_product`.`price`+`oc_product`.`price`*`oc_manufacturer_description`.`procent`/100 + `oc_manufacturer_description`.`koficient`) Where `oc_product`.`manufacturer_id` = `oc_manufacturer_description`.`manufacturer_id`");
		...
		foreach ($data['manufacturer_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "manufacturer_description SET manufacturer_id = '" . (int)$manufacturer_id . "', language_id = '" . (int)$language_id . "', description = '" . $this->db->escape($value['description']) . "', meta_title = '" . $this->db->escape($value['meta_title']) . "', meta_h1 = '" . $this->db->escape($value['meta_h1']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "', meta_keyword = '" . $this->db->escape($value['meta_keyword']) . "', kodp = '" . $this->db->escape($value['kodp']). "', procent = '" . $this->db->escape($value['procent']). "', koficient = '" . $this->db->escape($value['koficient']). "'");
            $this->db->query("Update `oc_product`, `oc_manufacturer_description` Set `oc_product`.`price` = (`oc_product`.`price2`+`oc_product`.`price2`*`oc_manufacturer_description`.`procent`/100 + `oc_manufacturer_description`.`koficient`) Where `oc_product`.`manufacturer_id` = `oc_manufacturer_description`.`manufacturer_id`");
		}
