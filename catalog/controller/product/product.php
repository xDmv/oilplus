...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
           ...
           // $data['kodp'] = $this->language->get('kodp');
           // $data['procent'] = $this->language->get('procent');
           // $data['koficient'] = $this->language->get('koficient');
            ...
            $data['kodp'] = $product_info['kodp'];
            $data['procent'] = $product_info['procent'];
            $data['koficient'] = $product_info['koficient'];
			$data['nalichie'] = $product_info['nalichie'];
