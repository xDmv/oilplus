...
$_['text_write']                              = '<i class="fa fa-pencil-square-o" aria-hidden="true"></i> Написать отзыв';
...
$_['text_success']                            = 'Спасибо за Ваш отзыв. Он был направлен на модерацию. Мы свяжемся с Вами!';
...
$_['entry_good']                              = '<i class="fa fa-thumbs-up" aria-hidden="true"></i> Хорошо';
$_['entry_bad']                               = '<i class="fa fa-thumbs-down" aria-hidden="true"></i> Плохо';

// Tabs
$_['tab_description']                         = '<i class="fa fa-align-justify" aria-hidden="true"></i> Описание';
$_['tab_attribute']                           = '<i class="fa fa-cog" aria-hidden="true"></i> Характеристики';
$_['tab_review']                              = '<i class="fa fa-commenting" aria-hidden="true"></i> Отзывы (%s)';
