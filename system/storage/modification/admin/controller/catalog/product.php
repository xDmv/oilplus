...
class ControllerCatalogProduct extends Controller {
    ...
    if ($this->config->get('config_editor_default')) {
		...
		$data['entry_model'] = $this->language->get('entry_model');
		$data['entry_nalichie'] = $this->language->get('entry_nalichie');
		...
		$data['help_nalichie'] = $this->language->get('help_nalishie');
		...
		if (isset($this->request->post['nalichie'])) {
			$data['nalichie'] = $this->request->post['nalichie'];
		} elseif (!empty($product_info)) {
