...
class ControllerCatalogManufacturer extends Controller {
    ...
    if ($this->config->get('config_editor_default')) {
        ...
        $data['text_kodp'] = $this->language->get('text_kodp');
        $data['text_procent'] = $this->language->get('text_procent');
        $data['text_koficient'] = $this->language->get('text_koficient');
        ...
        $data['entry_kodp'] = $this->language->get('entry_kodp');
        $data['entry_nadbavka'] = $this->language->get('entry_nadbavka');
		$data['entry_sort_order'] = $this->language->get('entry_sort_order');
		$data['entry_customer_group'] = $this->language->get('entry_customer_group');

		$data['help_keyword'] = $this->language->get('help_keyword');
        $data['help_kodp'] = $this->language->get('help_kodp');
        $data['help_nadbavka'] = $this->language->get('help_nadbavka');
        $data['help_procent'] = $this->language->get('help_procent');
        $data['help_koficient'] = $this->language->get('help_koficient');
