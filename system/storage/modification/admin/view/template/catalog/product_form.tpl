        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-nalichie"><span data-toggle="tooltip" title="<?php echo $help_nalichie; ?>"><?php echo $entry_nalichie; ?></span></label>
                <div class="col-sm-10">
                  <select name="nalichie" id="input-nalichie" class="form-control">
                    <?php if ($nalichie=="Есть в наличии") { ?>
                    <option value="Есть в наличии" selected="selected"><?php echo $nalichie; ?></option>
                    <option value="Под заказ"><?php echo "Под заказ"; ?></option>
					<option value="Товаp под заказ.&lt;br&gt; Доставка 1-3 дня."><?php echo "Товаp под заказ.&lt;br&gt; Доставка 1-3 дня."; ?></option>
                    <?php }  ?>
                    <?php if ($nalichie=="Под заказ") { ?>
                    <option value="Есть в наличии" ><?php echo "Есть в наличии"; ?></option>
                    <option value="Под заказ" selected="selected"><?php echo $nalichie; ?></option>
					<option value="Товаp под заказ.&lt;br&gt; Доставка 1-3 дня."><?php echo "Товаp под заказ.&lt;br&gt; Доставка 1-3 дня."; ?></option>
                    <?php }  ?>
                    <?php if ($nalichie=="Товаp под заказ.&lt;br&gt; Доставка 1-3 дня.") { ?>
                    <option value="Есть в наличии" ><?php echo "Есть в наличии"; ?></option>
                    <option value="Под заказ"><?php echo "Под заказ"; ?></option>
					<option value="Товаp под заказ.<br> Доставка 1-3 дня." selected="selected"><?php echo $nalichie; ?></option>
                    <?php }  ?>
                    <?php if ($nalichie=="") { ?>
                    <option value="Есть в наличии" ><?php echo "Есть в наличии"; ?></option>
                    <option value="Под заказ"><?php echo "Под заказ"; ?></option>
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-size"><span data-toggle="tooltip" title="<?php echo $help_size; ?>"><?php echo $entry_size; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="size" value="<?php echo $size; ?>" placeholder="<?php echo $entry_size; ?>" id="input-size" class="form-control" />
                </div>
              </div>			  
